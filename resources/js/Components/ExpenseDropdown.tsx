...
import { useDeleteExpenseStore, useExpenseModalStore } from '@/stores/expense-modal-store';
...
export default function ExpenseDropdown({ expense, categories }: Props) {

    const editModal = useExpenseModalStore((state) => state.editModal);
    const deleteModal = useDeleteExpenseStore((state) => state.openModal);
